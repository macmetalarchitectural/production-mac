...
class StockQuant(models.Model):
  ...
  def _apply_inventory(self, date=None):
    ...
    for quant in self:
      ...
      if quant.env.context.get('from_inverse_qty') and quant.product_uom_id.compare(quant.inventory_diff_quantity,
                                                                                    0) == 0:
        continue
      ...
      if quant.product_uom_id.compare(quant.inventory_diff_quantity, 0) > 0:
        move_vals.append(
          quant._get_inventory_move_values(quant.inventory_diff_quantity,
                                           ...
                                           quant.location_id, quant.note,quant.write_uid,
